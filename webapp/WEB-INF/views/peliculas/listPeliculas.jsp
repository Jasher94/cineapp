...
<%--             <c:forEach var="pelicula" items="${peliculas.content}"> 
 --%>          <c:forEach items="${peliculas.content}" var="pelicula"> 
                ...
                <td>
                    ...
                    <a href="${urlDelete}/${pelicula.id}"onclick='return confirm("Estas seguro de elimianr la pelicula?")' class="btn btn-danger btn-sm" role="button" title="Eliminar" ><span class="glyphicon glyphicon-trash"></span></a>
                </td>
                <tr></tr>
             </c:forEach> 
             <%-- </c:forEach> --%>

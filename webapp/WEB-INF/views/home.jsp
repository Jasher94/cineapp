...
<spring:url value="/" var="urlRoot"></spring:url>  <!-- hacer referecnia a direccion fuente -->
...
<body>
    ...
    ================================================== -->
        	...
        	<c:forEach items="${banners}" var="banner" varStatus="loop">
        		<c:choose>
	        		<c:when test="${loop.index==0}">
		            	...
		            	<img src="${urlPublic}/images/${banner.archivo}" alt="${banner.titulo}" title="${banner.titulo}" width="1140" height="250" >
		         	</div>
	        		</c:when>        	
		         <c:otherwise>
		         	<div class="item">         
		...
		<!-- Marketing messaging  
      informacion de las peliculas en cartelera-->
